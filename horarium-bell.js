...
const ANCHORS = [
  ...
  { id: "hor-examen", hour: 21, minute: 0, title: "Examen & Night Prayer", body: "Give thanks · review the day · rest in Him." }
];
...
async function setBells() {
  for (const a of ANCHORS) {
    ...
    n.body = a.body;
    n.sound = "default";
    n.openURL = APP_URL;              // tap the notification → opens Horarium
